...
training_type = '_aug1.5'
data_type = '_test-challenge'
val_path = os.path.join(baseDir, 'DAVIS/ImageSets/2017/test-challenge.txt')
with open(val_path, 'r') as f:
    seq_names = [line.strip() for line in f]
start_id = int(sys.argv[3])
end_id = int(sys.argv[4])
for seq_name in seq_names[start_id:end_id]:
    print seq_name
    gpu_id = sys.argv[1]
